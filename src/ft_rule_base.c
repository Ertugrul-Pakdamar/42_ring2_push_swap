...
/*   Updated: 2025/07/28 15:33:13 by epakdama         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (ft_strncmp(rule, "sa", ft_strlen(rule)) == 0 || ft_strncmp(rule, "sb",
			ft_strlen(rule)) == 0 || ft_strncmp(rule, "ss",
			ft_strlen(rule)) == 0)
		ft_swap(stack_a, stack_b, rule);
	else if (ft_strncmp(rule, "pa", ft_strlen(rule)) == 0 || ft_strncmp(rule,
				"pb", ft_strlen(rule)) == 0)
		ft_push(stack_a, stack_b, rule);
	else if (ft_strncmp(rule, "ra", ft_strlen(rule)) == 0 || ft_strncmp(rule,
				"rb", ft_strlen(rule)) == 0 || ft_strncmp(rule, "rr",
				ft_strlen(rule)) == 0)
		ft_rotate(stack_a, stack_b, rule);
	else if (ft_strncmp(rule, "rra", ft_strlen(rule)) == 0 || ft_strncmp(rule,
				"rrb", ft_strlen(rule)) == 0 || ft_strncmp(rule, "rrr",
				ft_strlen(rule)) == 0)
